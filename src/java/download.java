...
FileWriter fstream = new FileWriter("C:\\Users\\Ashrutha\\Desktop\\multistorage\\multistorage\\output01.txt");
                    ...
                    if (rs.next()) {
                        ...
                        if (i == 1) {
                            AESDecryption dec = new AESDecryption();
                                ...
                                RequestDispatcher rs2 = request.getRequestDispatcher("uploadlist.jsp");
                        ...
                        if (i == 1) {
                            ...
                            url1 = "" + so.getAttribute("un") + "filekeyfor" + b + "&phone=" + mob + "&provider=way2sms";
